...
define php::fpm::pool (
  ...
  $listen_owner = pick($::php::fpm::config::listen_owner,undef)
  $listen_group = pick($::php::fpm::config::listen_group,undef)
  $listen_mode = pick($::php::fpm::config::listen_mode,undef)
